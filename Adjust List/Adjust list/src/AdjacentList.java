...
public class AdjacentList {
	    ...
	    public static void main(String[] args)
	    {
	        ...
	        System.out.println("Enter " + edges + " edges. Two integers v1, v2, ");
	        ...
	        for (int i = 0; i < edges; ++i) {
	            ...
	            // Adding edge v1 -> v2
	            adjacencyList[v1] = insertEdge(adjacencyList[v1], new Node(v2));
	    ...
	    public static Node insertEdge(Node oldHead, Node newEdge)
	    {
